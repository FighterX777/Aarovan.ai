    ...
    <div className="bg-background text-on-background font-body">
      ...
      <main className="max-w-7xl mx-auto px-8 py-16">
        ...
        <header className="mb-24 flex flex-col items-start gap-4">
          ...
          <h1 className="font-headline text-6xl md:text-7xl font-extrabold text-primary leading-tight max-w-3xl">Partner with Us</h1>
          <p className="font-body text-xl text-on-surface-variant max-w-xl leading-relaxed mt-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          {/* Contact Form Block */}
          <div className="lg:col-span-7 bg-surface-container-low rounded-xl p-10 flex flex-col gap-8">
          ...
          <div className="lg:col-span-5 flex flex-col gap-10">
            {/* Direct Contact */}
            <div className="bg-surface-container p-8 rounded-xl flex flex-col gap-6">
        ...
        {/* CTA Section */}
        <section className="mt-32 mb-16 bg-primary-container rounded-xl overflow-hidden relative">
