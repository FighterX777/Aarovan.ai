      ...
      <main>
        ...
        <section className="relative py-24 md:py-32 px-8 overflow-hidden">
          <div className="max-w-7xl mx-auto flex flex-col items-start gap-8 relative z-10">
            ...
            <h1 className="font-headline text-5xl md:text-7xl font-extrabold text-primary max-w-4xl leading-tight">
              About Aarovan.ai
            </h1>
        ...
        <section className="bg-surface-container py-24 px-8">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-7">
              <div className="bg-surface-container-lowest editorial-shadow p-12 rounded-xl relative overflow-hidden ghost-border">
            ...
            <div className="lg:col-span-5 flex flex-col gap-8">
              <div className="bg-surface-container-high p-8 rounded-lg ghost-border">
        ...
        <section className="bg-surface-container-low py-24 px-8 overflow-hidden">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="relative">
              <div className="bg-surface-container-highest w-full aspect-square rounded-xl overflow-hidden editorial-shadow -rotate-2 relative">
                <img 
        ...
        <section className="py-24 px-8 relative">
          <div className="max-w-5xl mx-auto glass-panel p-12 md:p-20 rounded-[2rem] editorial-shadow text-center relative z-10 ghost-border">
